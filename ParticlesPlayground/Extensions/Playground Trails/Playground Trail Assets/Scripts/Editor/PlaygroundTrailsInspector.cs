...
#region LWS
	SerializedProperty s_overrideSorting;
	SerializedProperty s_overrideSortingLayerName;
	SerializedProperty s_overrideSortingOrder;
#endregion
...
#region LWS
		s_overrideSorting = s_trails.FindProperty("overrideSorting");
		s_overrideSortingLayerName = s_trails.FindProperty("overrideSortingLayerName");
		s_overrideSortingOrder = s_trails.FindProperty("overrideSortingOrder");
#endregion
	...
	public override void OnInspectorGUI ()
	{
		...
		s_trails.UpdateIfRequiredOrScript();
...
#region LWS
				bool isSortingOverriden = s_overrideSorting.boolValue;
				EditorGUILayout.PropertyField(s_overrideSorting);
				if(isSortingOverriden)
				{
					EditorGUILayout.PropertyField(s_overrideSortingLayerName);
					EditorGUILayout.PropertyField(s_overrideSortingOrder);
				}
#endregion
