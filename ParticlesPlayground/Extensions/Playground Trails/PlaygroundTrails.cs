...
namespace ParticlePlayground {
	...
	public class PlaygroundTrails : MonoBehaviour {
		...
		void Update ()
		{
			...
			if (_currentParticleCount != playgroundSystem.particleCount || _currentParticleMinLifetime != playgroundSystem.lifetimeMin || _currentParticleMaxLifetime != playgroundSystem.lifetime || _localSpace != (playgroundSystem.shurikenParticleSystem.main.simulationSpace == ParticleSystemSimulationSpace.Local))
				ResetTrails();
...
#region LWS
				_parentGameObject.layer = gameObject.layer;
				_parentGameObject.transform.SetParent(transform, false);
#endregion
...
#region LWS
			newTrail.trailGameObject.layer = gameObject.layer;
#endregion
		...
		public void ResetTrails () {
			...
			if (playgroundSystem != null && gameObject.activeInHierarchy)
			{
				...
				_localSpace = playgroundSystem.shurikenParticleSystem.main.simulationSpace == ParticleSystemSimulationSpace.Local;
			}
