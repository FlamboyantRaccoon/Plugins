...
public abstract class RRDictionaryDrawer<TK, TV> : PropertyDrawer
{
    private RRCollections.RRSerializedDictionary <TK, TV> _Dictionary;
    ...
    private void CheckInitialize(SerializedProperty property, GUIContent label)
    {
        if (_Dictionary == null)
        {
            ...
            Debug.Log(target.name + " : " + target.GetType().ToString() + " // " + property.displayName + " : " + label.text );
            _Dictionary = fieldInfo.GetValue(target) as RRCollections.RRSerializedDictionary<TK, TV>;
            if (_Dictionary == null)
            {
                _Dictionary = new RRCollections.RRSerializedDictionary<TK, TV>();
...
[CustomPropertyDrawer(typeof(RRCollections.StringDictionary))]
public class StringDictionaryDrawer : RRDictionaryDrawer<string, string> { }
